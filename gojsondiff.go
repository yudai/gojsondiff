...
func (differ *Differ) Compare(
	...
	return differ.CompareObjects(leftObj, rightObj), nil
}
...
func (differ *Differ) CompareObjects(
	...
	_, delta := differ.compareValues(Root, left, right)
...
func (differ *Differ) ApplyPatch(json interface{}, patch Diff) {
	var delta interface{}
	...
	switch delta.(type) {
	case PreDelta:
		delta.(PreDelta).PreApply(wrap)
	case PostDelta:
		delta.(PostDelta).PostApply(wrap)
	}
}
